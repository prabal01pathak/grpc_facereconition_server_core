...
_REGISTERMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='image', full_name='bidirectional.RegisterMessage.image', index=1,
...
_FACEREGISTRATION = _descriptor.ServiceDescriptor(
  name='FaceRegistration',
  full_name='bidirectional.FaceRegistration',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='bidirectional.FaceRegistration.GetRegisterFace',
    index=0,
    containing_service=None,
...
_sym_db.RegisterServiceDescriptor(_FACEREGISTRATION)

DESCRIPTOR.services_by_name['FaceRegistration'] = _FACEREGISTRATION
