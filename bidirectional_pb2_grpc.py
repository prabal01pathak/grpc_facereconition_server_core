...
class FaceRegistrationStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.GetRegisterFace = channel.unary_unary(
                '/bidirectional.FaceRegistration/GetRegisterFace',
...
class FaceRegistrationServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_FaceRegistrationServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'bidirectional.FaceRegistration', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class FaceRegistration(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GetRegisterFace(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/bidirectional.FaceRegistration/GetRegisterFace',
